...
num_epochs = 5 ###for grid search
Num_EPOCHS = 5 ###for training
###sub-network setup
...
###train CoxPASNet with optimal hyperparameters using train data, and then evaluate the trained model with test data
###Note that test data are only used to evaluate the trained CoxPASNet
